...
## ---- fig.width=7.93, fig.height=5.86-----------------------------------------------------
...
#' 
## ---- echo=FALSE, fig.height = 4.7, fig.width = 8-----------------------------------------
...
#' 
## ---- warning=FALSE, fig.width=7.3, fig.height=9.3----------------------------------------
(save3 <- gap +
