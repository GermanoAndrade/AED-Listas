...
Reproduza o gráfico de Minard que representa a jornada do lider político Napoleão ao levar seu exército para a Campanha Russa.  
...
```{r , warning=FALSE, fig.height = 2.5, fig.width = 10}
(t2 <- t1 + 
...
```{r , include=FALSE,fig.height = 4.7, fig.width = 10}
