...
#' 
## ---------------------------------------------------------------------
#Nesse ponto o que se faz é "atualizar" os dados do gráfico, uma vez que eles foram 
#modificados. O 'pc4' havia herdado desde o 'pc1'  o "ggplot(data = dat,...)", 
#então foi preciso colocar o 'dat' modificado sem precisar repetir todo o processo.
...
#Apenas mapeando os pontos através de linhas e agrupando pelos diferentes grupos da 
#tropa, já obtemos algo parecido com o gráfico final:
ggplot() + 
...
#habitantes e apenas uam casa decimal:
...
#' 
## ---------------------------------------------------------------------
tab_covid <- read.csv("./Databases/Atirei o Pau no Gráfico/HIST_PAINEL_COVIDBR_18mai2020.CSV", 
                      sep = ";",stringsAsFactors = FALSE)
