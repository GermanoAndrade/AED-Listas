...
#' 
#' 
## ---- include=FALSE, fig.cap= "[1]Histogramas no tamanho normal no final da lista."-------
...
## ---- include=FALSE, fig.cap= "[2]Histogramas no tamanho normal no final da lista."-------
