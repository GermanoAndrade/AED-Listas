...
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-a.PNG")
```
```{r}
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-b.PNG")
```
...
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-c.PNG")
```
```{r}
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-d.PNG")
```
```{r}
...
```
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-e.PNG")
```
```{r}
#Resposta
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-f.PNG")
```
```{r}
#Resposta
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 2/Questão_9-g.PNG")
```
...
### Questão 32
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_32_1.PNG")
```
```{r , echo=FALSE, out.width = '66%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_32_2.PNG")
```
```{r}
...
### Questão 33
knitr::include_graphics("./Questões/Capítulo 3/Questão_33.PNG")
```
...
```{r , include=FALSE, out.width = '80%'}
### Questão 34
knitr::include_graphics("./Questões/Capítulo 3/Questão_34.PNG")
```
...
### Questão 37
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_37_1.PNG")
```
```{r , echo=FALSE, out.width = '70%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_37-a.PNG")
```
```{r}
#Resposta
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_37-b.PNG")
```
...
knitr::include_graphics("./Questões/Capítulo 3/Questão_37-c.PNG")
```
```{r}
...
```
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_37-d.PNG")
```
```{r}
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 3/Questão_37-e.PNG")
```
...
* Então, temos que $0<0,6<0,72$$\iff$$Direito< Estatística< Política$. Portanto, o _desempenho relativo_ do funcionário ${\bf1}$ foi melhor em **Política**.

# Capítulo 4

### Questão 19
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_19-a.PNG")
```
```{r}
A_Favor <- c(30, 35, 35)
Contra <- c(60, 25, 15)
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_19-b.PNG")
```
```{r}
#Resposta
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_19-c.PNG")
```
...
### Questão 20
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_20.PNG")
```
```{r}
...
### Questão 22
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_22-1.PNG")
```
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_22-a.PNG")
```
```{r}
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_22-b.PNG")
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_22-c.PNG")
```
...
### Questão 29
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_29.PNG")
```
```{r , echo=FALSE}
...
knitr::include_graphics("./Questões/Capítulo 4/Questão_29_Dados.PNG")
```
```{r , echo=FALSE, out.width = '70%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_29-a.PNG")
```
...
knitr::include_graphics("./Questões/Capítulo 4/Questão_29-b.PNG")
```
```{r}
...
knitr::include_graphics("./Questões/Capítulo 4/Questão_29-c.PNG")
```
```{r}
ggplot(data = NULL, 
       aes(x = Salario[1,], 
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_29-d.PNG")
```
```{r}
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_29-e.PNG")
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_29-f.PNG")
```
...
### Questão 30
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30.PNG")
```
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-Variáveis.PNG")
```
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-Tabela.PNG")
```
...
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-Dados.PNG")
```
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-a.PNG")
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-b.PNG")
```
```{r}
#Média:
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-c.PNG")
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-d.PNG")
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-e.PNG")
```
...
*  Dessa forma, a partir das correlações entre as váriaveis, com $0,2632924 < 0,704746$ $\Longleftrightarrow$ $Experiência < Teste$, podemos afirmar que a Variável $T: teste$ exerce mais influência na variável $V: vendas$, ou seja, no número de vendas do vendedor. Desse modo, a variável $T: teste$ é a mais importante para julgar um futuro candidato ao emprego.


```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-f.PNG")
```
...
```{r , echo=FALSE, out.width = '80%'}
knitr::include_graphics("./Questões/Capítulo 4/Questão_30-g.PNG")
```
